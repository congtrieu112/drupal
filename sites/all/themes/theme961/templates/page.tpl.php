...
<?php if ( !theme_get_setting( 'theme961_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme961_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1 clearfix"> <!-- Sticky menu wrapper -->
				<div class="container-12">
				...
				<!-- Region Header -->
				<?php if ( $page['header'] ) : 
					theme961_region_preffix ( 'header' );
						print render( $page['header'] );
					theme961_region_suffix ( 'header' );
				endif; ?>
			</div>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) : 
				theme961_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme961_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_top'] ) : 
				theme961_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme961_region_suffix ( 'content_top' );
			endif; ?>
			...
			<?php if ( $page['content_bottom'] ) : 
				theme961_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme961_region_suffix ( 'content_bottom' );
			endif; ?>

			<!-- Region parallax one -->
			<?php if ( $page['parallax_one'] ) : 
				theme961_region_preffix ( 'parallax_one' );
					print render( $page['parallax_one'] );
				theme961_region_suffix ( 'parallax_one' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme961_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme961_region_suffix ( 'footer_top' );
			endif; ?>
			...
			<div class="footer-wrapper clearfix">
				<div class="container-12">
					<div class="grid-12 clearfix">
						...
						<?php if ( $is_front ) : ?>
							More <a rel="nofollow" href="http://www.templatemonster.com/category/museum-drupal-themes/" target="_blank">Museum Drupal Themes at TemplateMonster.com</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
