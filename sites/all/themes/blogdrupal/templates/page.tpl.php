...
<div id="header">
    <div class="container">
        <div class="logoContainer"><a href="1_home.html"><img
                    src="<?php echo base_path() . path_to_theme() ?>/img/logo.png" alt=""></a></div>
        <div class="topData">
            <ul class="social">
    ...
    <div class="container">
        <div class="column1 pull-left">
            <div class="slider1Back">
                <div class="slider1"><img src="<?php echo base_path() . path_to_theme() ?>/img/slider1-frame.png" alt=""
                                          class="frame1">

                    <div class="sliderContent">
                        <div class="slider-wrapper">
                            <div id="slider1Nivo" class="nivoSlider">
                                <div class="slider1Frame"><img
                                        src="<?php echo base_path() . path_to_theme() ?>/img/content/slider_small_01.jpg"
                                        alt=""></div>
                                <div class="slider1Frame"><img
                                        src="<?php echo base_path() . path_to_theme() ?>/img/content/slider_small_02.jpg"
                                        alt=""></div>
                                <div class="slider1Frame"><img
                                        src="<?php echo base_path() . path_to_theme() ?>/img/content/slider_small_03.jpg"
                                        alt=""></div>
                                <div class="slider1Frame"><img
                                        src="<?php echo base_path() . path_to_theme() ?>/img/content/slider_small_04.jpg"
                                        alt=""></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="setSlider2">
                            <div class="third">
                                <div class="mrgThird"><span class="tx1">Grill Menu No.1</span>
                                    ...
                                    <p><strong>There are many</strong> variations of passages of Lorem Ipsum available,
                                        but the majority.</p>
                                    <span class="tx2">only 7.99 $</span>

                                    <div class="shadd"><a
                                            href="<?php echo base_path() . path_to_theme() ?>/img/content/dish17.jpg"
                                            data-rel="lightbox"><img
                                                src="<?php echo base_path() . path_to_theme() ?>/img/content/dish4.jpg"
                                                alt=""></a></div>
                                </div>
                            </div>
                            <div class="third">
                                <div class="mrgThird"><span class="tx1">Grill Menu No.2</span>
                                    ...
                                    <div class="shadd"><a
                                            href="<?php echo base_path() . path_to_theme() ?>/img/content/dish17.jpg"
                                            data-rel="lightbox"><img
                                                src="<?php echo base_path() . path_to_theme() ?>/img/content/dish5.jpg"
                                                alt=""></a></div>
                                </div>
                            </div>
                            <div class="third">
                                <div class="mrgThird"><span class="tx1">Grill Menu No.3</span>
                                    ...
                                    <div class="shadd"><a
                                            href="<?php echo base_path() . path_to_theme() ?>/img/content/dish17.jpg"
                                            data-rel="lightbox"><img
                                                src="<?php echo base_path() . path_to_theme() ?>/img/content/dish6.jpg"
                                                alt=""></a></div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
            ...
            <div class="blogContent">
                ...
                <img src="<?php echo base_path() . path_to_theme() ?>/img/content/post1-photo.jpg" alt="">
            ...
            <div class="threeColumnGallery">
                <div class="third">
                    <div class="mrgThird"><span class="tx1">Grill Menu No.1</span>
                        ...
                        <p><strong>There are many</strong> variations of passages of Lorem Ipsum available, but the
                            majority.</p>
                        <span class="tx2">only 7.99 $</span> <img
                            src="<?php echo base_path() . path_to_theme() ?>/img/content/dish1.jpg" alt=""></div>
                </div>
                <div class="third">
                    <div class="mrgThird"><span class="tx1">Grill Menu No.2</span>
                        ...
                        <p><strong>There are many</strong> variations of passages of Lorem Ipsum available, but the
                            majority.</p>
                        <span class="tx2">only 7.99 $</span> <img
                            src="<?php echo base_path() . path_to_theme() ?>/img/content/dish2.jpg" alt=""></div>
                </div>
                <div class="third">
                    <div class="mrgThird"><span class="tx1">Grill Menu No.3</span>
                        ...
                        <p><strong>There are many</strong> variations of passages of Lorem Ipsum available, but the
                            majority.</p>
                        <span class="tx2">only 7.99 $</span> <img
                            src="<?php echo base_path() . path_to_theme() ?>/img/content/dish3.jpg" alt=""></div>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
        <div class="column2 pull-right">
            ...
            <div class="box3"><span class="tx1">Argentinian</span> <span class="tx2">T-Bone Steak</span>
                ...
                <p><strong>There are many</strong> variations of passages of Lorem Ipsum available, but the majority
                    have suff.</p>
            ...
            <div class="box4">
                <div class="mCont"> This is my absolute favorite restaurant. Food is always fresh. Go on like that!!
                </div>
                <div class="btm"></div>
                <img src="<?php echo base_path() . path_to_theme() ?>/img/content/avatar-say1.jpg" alt=""> <span
                    class="author">Floyd, Cramer - Kansas</span>
        ...
        <div class="c2btm">
            <div class="photoSidebar"><img src="<?php echo base_path() . path_to_theme() ?>/img/content/deco.jpg"
                                           alt=""></div>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="container">
        ...
        <div class="mid">
            <div class="col1">
                ...
                <span class="day">Monday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Tuesday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Wendsday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Thursday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Friday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Saturday</span> <span class="hour">11:00 am - 09:00 pm</span> <span
                    class="day">Sunday</span> <span class="hour">11:00 am - 09:00 pm</span></div>
            <div class="col2">
                <h4><span class="lft"></span>Contact & Location<span class="rt"></span></h4>

                <div class="brdr">
                    <div class="ftMap">
                        <iframe width="151" height="117"
                                src="http://maps.google.pl/maps?f=q&amp;source=s_q&amp;hl=pl&amp;geocode=&amp;q=123+Eastern+12th+ST+New+York,+NY&amp;aq=&amp;sll=51.923943,27.608643&amp;sspn=6.879039,16.907959&amp;ie=UTF8&amp;hq=123+Eastern&amp;hnear=W+12th+St,+New+York,+Stany+Zjednoczone&amp;ll=40.741588,-73.990536&amp;spn=0.016663,0.024356&amp;t=m&amp;output=embed&amp;iwloc=near"></iframe>
                        <br/>
                        <small><a
                                href="http://maps.google.pl/maps?f=q&amp;source=embed&amp;hl=pl&amp;geocode=&amp;q=123+Eastern+12th+ST+New+York,+NY&amp;aq=&amp;sll=51.923943,27.608643&amp;sspn=6.879039,16.907959&amp;ie=UTF8&amp;hq=123+Eastern&amp;hnear=W+12th+St,+New+York,+Stany+Zjednoczone&amp;ll=40.741588,-73.990536&amp;spn=0.016663,0.024356&amp;t=m"
                                style="color:#0000FF;text-align:left">Get Directions</a></small>
                    </div>
            ...
            <div class="col3">
                <div class="lftMrg">
                    ...
                    <span class="data1">22 June, 2011 <img
                            src="<?php echo base_path() . path_to_theme() ?>/img/data1-dot.png"
                            alt=""> no comments</span> <a href="#">Pellentesque habitant morbi tristique senectus et
                        netus et male. </a> <span class="data1">7 May, 2011 <img
                            src="<?php echo base_path() . path_to_theme() ?>/img/data1-dot.png"
                            alt=""> 11 comments</span> <a href="#">Pellentesque habitant morbi tristique senectus et
                        netus et male. </a></div>
            </div>
            <div class="clearfix"></div>
        </div>
